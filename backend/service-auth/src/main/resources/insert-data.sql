...
insert into restaurant_service_oauth.role values(1,'ROLE_USER');
insert into restaurant_service_oauth.role values(2,'ROLE_ADMIN');
...
INSERT INTO `restaurant_service_oauth`.`user_role`(`user_id`,`role_id`) VALUES (2,1);
...
INSERT INTO `restaurant_service_oauth`.`user_role`(`user_id`,`role_id`) VALUES (3,1);
...
insert into restaurant_service_oauth.role_privilege values(2,3);
